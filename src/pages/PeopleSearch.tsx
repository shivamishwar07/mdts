...
//             },
//         },
//         { title: "RACI", dataIndex: "category", key: "category", width: 110, align: "center" },
//     ];
...
import { useEffect, useMemo, useRef, useState } from "react";
import dayjs from "dayjs";
import { Input, List, Table, Tag, Typography, Tooltip } from "antd";
import type { ColumnsType } from "antd/es/table";
import { FolderOpenOutlined, UserOutlined, InfoCircleOutlined } from "@ant-design/icons";
import eventBus from "../Utils/EventEmitter";
import { db } from "../Utils/dataStorege";
import { getCurrentUser } from "../Utils/moduleStorage";
import "../styles/status-update.css";
        ...
        },
        {
            title: (
                <div style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                    <span>RACI</span>
                    <Tooltip title="R : Responsible, A : Accountable,C : Consulted, I : Informed,">
                        <InfoCircleOutlined />
                    </Tooltip>
                </div>
            ),
    ...
    return (
        <div className="people-search-container" ref={containerRef}>
            <div className="people-search-header">
                <div className="people-search-header-left">
                    <p className="page-heading-title">Search by People – RACI View</p>
                    <span className="pl-subtitle">See where a person is mapped as R/A across projects</span>
                </div>
                    ...
                    {showEmptyRaci && (
                        <div className="container-msg">
                            <div className="no-project-message">
                                <FolderOpenOutlined className="raci-empty-icon" />
                                <h3>No RACI Assignments</h3>
                                <p>This person is currently not mapped as R/A in any project.</p>
                            </div>
                        </div>
                    )}
