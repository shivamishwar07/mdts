...
const ManageRaci = () => {
  ...
  return (
    <>
      <div className="manage-raci-heading">
        <div className="status-update-header raci-header">
          <p>Search by People – RACI View</p>

          <Button
            size="small"
            icon={<ArrowLeftOutlined />}
            onClick={() => navigate("/dashboard")}
            className="raci-back-btn"
      ...
      <div className="main-raci-status-update">
        {allProjects.length ? (
          <>
